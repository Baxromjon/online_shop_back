...
@DynamicInsert
@DynamicUpdate
@Entity(name = EntityName.ORDER_MONTH_PAYMENT)
@SQLDelete(sql = "UPDATE " + EntityName.ORDER_MONTH_PAYMENT + " SET deleted = TRUE WHERE id=?")
@Where(clause = "deleted=false")
public class OrderMonthPayment extends AbsEntity {
